...
enum DriveCacheStrategy {
  ...
  /// Serve from cache only, don't fetch
  cacheFirst,
...
abstract class DriveRepository {
  ...
  Future<DriveResult<List<DriveFile>>> refreshPdfFiles();
